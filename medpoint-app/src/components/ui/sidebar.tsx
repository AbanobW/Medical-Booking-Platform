...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      {comp}
      <TooltipContent
        // Logical, not physical: the tooltip must sit on the far side of the
        // rail from the content — right of a left sidebar (LTR), left of a
        // right sidebar (RTL). `inline-end` is both.
        side="inline-end"
        align="center"
