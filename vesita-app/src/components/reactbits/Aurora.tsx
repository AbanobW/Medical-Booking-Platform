...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    // `resize()` below closes over this before it is assigned, so it cannot be
    // a const — the rule is measuring assignments, not the closure it feeds.
    ...
    // Intentionally not reactive to `colorStops` / `blend`: the render loop reads
    // them live from `propsRef`, and re-running this effect would tear down and
    // rebuild the WebGL context on every prop change.
